...
import kotlinx.android.synthetic.main.fragment_gank_list.fab
import kotlinx.android.synthetic.main.fragment_gank_list.rv_gank
 ...
 * @desc:
 */
class GankListFragment : LazyFragment(), PullLoadMoreListener {
  ...
  companion object {
    ...
    fun newInstance(type: String): GankListFragment {
  ...
  override fun onCreateView(inflater: LayoutInflater,
    ...
    layout = container!!.inflate(R.layout.fragment_gank_list)
    return layout
  }
  ...
  override fun onActivityCreated(savedInstanceState: Bundle?) {
    ...
    rv_gank.apply {
      ...
      setLinearLayout()
      setOnPullLoadMoreListener(this@GankListFragment)
  ...
  private fun loadGankList(type: String) {
