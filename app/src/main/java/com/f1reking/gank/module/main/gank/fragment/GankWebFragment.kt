...
import kotlinx.android.synthetic.main.fragment_gank_web.*
 ...
 * @desc:
 */
class GankWebFragment : LazyFragment(), PullLoadMoreListener {
    ...
    override fun onCreateView(inflater: LayoutInflater,
        ...
        layout = container!!.inflate(R.layout.fragment_gank_web)
        return layout
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        rv_gank.apply {
            ...
            setLinearLayout()
            setOnPullLoadMoreListener(this@GankWebFragment)
