...
import kotlinx.android.synthetic.main.fragment_gank_app.*
...
class GankAppFragment : LazyFragment(), PullLoadMoreListener {
    ...
    override fun onCreateView(inflater: LayoutInflater,
        ...
        layout = container!!.inflate(R.layout.fragment_gank_app)
        return layout
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        rv_gank.apply {
            ...
            setLinearLayout()
            setOnPullLoadMoreListener(this@GankAppFragment)
